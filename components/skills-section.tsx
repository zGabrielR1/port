...
export function SkillsSection() {
  ...
  return (
    <section id="skills" className="py-20 bg-muted/10 relative">
      ...
      <div className="absolute top-20 right-1/4 w-72 h-72 bg-accent/3 rounded-full blur-3xl" />
      <div className="absolute bottom-20 left-1/4 w-80 h-80 bg-primary/2 rounded-full blur-3xl" />
